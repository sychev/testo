...
Этот документ подробно объясняет, что и **почему** было изменено в библиотеке `coro`.
Он рассчитан на читателя, который раньше с этой библиотекой не работал: по ключевым
местам приводится код «было/стало» с разбором.
